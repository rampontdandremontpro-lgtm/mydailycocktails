...
fun DetailScreen(
    ...
    var note by remember(cocktailId) { mutableStateOf(viewModel.getNote(cocktailId)) }
    var rating by remember(cocktailId) { mutableStateOf(viewModel.getRating(cocktailId)) }
            ...
            Column(
                ...
                Row(
                    ...
                    Surface(
                        onClick = {
                            ...
                            context.startActivity(Intent.createChooser(intent, "Partager le cocktail"))
                        },
                        shape = RoundedCornerShape(10.dp),
                ...
                Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                    ...
                    RatingStars(
                        ...
                        onRatingSelected = {
                            rating = it
                            viewModel.saveRating(cocktailId, it)
                        }
                    )
                }
                ...
                Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    ...
                    Button(
                        onClick = { viewModel.saveNote(cocktailId, note) },
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(48.dp),
                        shape = RoundedCornerShape(12.dp),
                        ...
                        Text("Sauvegarder la note", fontWeight = FontWeight.SemiBold)
                    }
                }
            }
        }
